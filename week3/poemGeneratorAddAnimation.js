...
function litany() {
    ...
    if (2 > t) { // 5 is how many paragraph of the poem will be produced in the web page
        t += 1;
    } else {
...
function produce_litany() {
    "use strict";
    litany();
    setInterval(litany, 10000); // 10000 is how long the next paragraph of the poem will appear
}